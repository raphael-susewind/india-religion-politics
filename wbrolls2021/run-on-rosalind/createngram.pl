...
system("ngram-count -order 3 -text ngram-hindu-raw -lm ngram-hindu-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-muslim-raw -lm ngram-muslim-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-christian-raw -lm ngram-christian-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-sikh-raw -lm ngram-sikh-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-parsi-raw -lm ngram-parsi-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-buddhist-raw -lm ngram-buddhist-lm -interpolate -unk");
system("ngram-count -order 3 -text ngram-jain-raw -lm ngram-jain-lm -interpolate -unk");
