...
foreach my $file (@files) {
    ...
    system('ls -v temp* | singularity exec /scratch/users/k1639346/tesseract-ocr_latest.sif tesseract -l ben+eng --tessdata-dir /scratch/users/k1639346/tessdata_best/ -c stream_filelist=true - - pdf > '.$new);
    system('rm temp*');
#    system("rm $file");
}
