...
$dbh->do ("CREATE TABLE delhiid2014 (ac_id_09 INTEGER, booth_id_14 INTEGER)");
$dbh->do ("INSERT INTO delhiid2014 (ac_id_09, booth_id_14) SELECT constituency, booth FROM booths");
...
system("sqlite3 temp.sqlite '.dump delhiid2014' > delhirolls2014-b.sql");
