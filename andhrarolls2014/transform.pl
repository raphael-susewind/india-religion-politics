...
$dbh->do ("CREATE TABLE andhraid2014 (ac_id_09 INTEGER, booth_id_14 INTEGER)");
$dbh->do ("INSERT INTO andhraid2014 (ac_id_09, booth_id_14) SELECT constituency, booth FROM booths");
...
system("sqlite3 temp.sqlite '.dump andhraid2014' > andhrarolls2014-b.sql");
