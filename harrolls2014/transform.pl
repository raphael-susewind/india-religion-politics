...
$dbh->do ("CREATE TABLE harid2014 (ac_id_09 INTEGER, booth_id_14 INTEGER)");
$dbh->do ("INSERT INTO harid2014 (ac_id_09, booth_id_14) SELECT constituency, booth FROM booths");
...
system("sqlite3 temp.sqlite '.dump harid2014' > harrolls2014-b.sql");
