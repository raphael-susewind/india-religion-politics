...
$dbh->do ("CREATE TABLE mahaid2014 (ac_id_09 INTEGER, booth_id_14 INTEGER)");
$dbh->do ("INSERT INTO mahaid2014 (ac_id_09, booth_id_14) SELECT constituency, booth FROM booths");
...
system("sqlite3 temp.sqlite '.dump mahaid2014' > maharolls2014-b.sql");
