...
$dbh->do ("CREATE TABLE rajid2014 (ac_id_09 INTEGER, booth_id_14 INTEGER)");
$dbh->do ("INSERT INTO rajid2014 (ac_id_09, booth_id_14) SELECT constituency, booth FROM booths");
...
system("sqlite3 temp.sqlite '.dump rajid2014' > rajrolls2014-b.sql");
