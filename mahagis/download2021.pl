...
system("echo 'create table mahagis as select distinct ac \"ac_id_09\", booth \"booth_id_21\", latitude, longitude from electoralsearch where state = \"Maharashtra\";' | sqlite3 electoralsearch.in.sqlite");
system("echo 'ALTER TABLE mahagis ADD COLUMN booth_id_21 INTEGER;' > mahagis2021.sql");
system("echo '.dump mahagis' | sqlite3 electoralsearch.in.sqlite >> mahagis2021.sql");
system("sed -i 's/VALUES/(ac_id_09, booth_id_21, latitude, longitude) VALUES/g' mahagis2021.sql");
