...
ATTACH '2017/booths-locality-modis.sqlite' AS booths2017;
CREATE TABLE upgis (ac_id_09 INTEGER, booth_id_09 INTEGER, booth_name_09 CHAR, district_name_09 CHAR, booth_id_12 INTEGER, booth_name_12 CHAR, district_name_12 CHAR, booth_id_14 INTEGER, booth_name_14 CHAR, district_name_14 CHAR, booth_id_17 INTEGER, district_name_17 CHAR, latitude FLOAT, longitude FLOAT, modis CHAR, modis_rank INTEGER);
...
INSERT INTO upgis (ac_id_09,booth_id_17,district_name_17,latitude,longitude,modis,modis_rank) SELECT constituen, booth, district_n, latitude, longitude,featurecla,scalerank FROM booths2017.booths_locality_modis;
.once upgis.sql
.dump upgis
.mode csv
.headers on
